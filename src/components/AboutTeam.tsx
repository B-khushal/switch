    ...
    <section id="about" className="py-20 md:py-32 bg-transparent">
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <span className="inline-flex items-center px-4 py-1.5 rounded-full bg-[#FFF8EE] border border-brand/20 text-brand text-xs font-bold uppercase tracking-widest mb-4">Our DNA</span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#111111] leading-[1.02] tracking-tight mb-6">
              We're Not Here <span className="text-brand">To Just Post Content.</span>
            </h2>
            <p className="text-base sm:text-lg text-black/60 mb-5 leading-relaxed">
              ...
              <div className="flex -space-x-3 sm:-space-x-4">
                {[1, 2, 3, 4].map((i) => (
                  <div 
                    ...
                    className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border-2 border-white bg-gray-200 overflow-hidden shadow-sm"
                  >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="relative h-[320px] sm:h-[440px] lg:h-[560px] rounded-[24px] sm:rounded-[32px] overflow-hidden shadow-2xl shadow-black/10 border border-black/5"
          >
            <img 
